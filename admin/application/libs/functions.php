...
*/
 ...
 $ACCESS_PWD='ugg2014_*!'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"innomative",#required
 'pwd'=>"ewf34ftr894$*%Y7", #required
 'db'=>"innomative",  #optional, default DB
